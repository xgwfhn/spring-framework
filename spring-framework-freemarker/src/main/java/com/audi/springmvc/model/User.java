...
@Entity
@Table(name="t_user")
/*@NamedStoredProcedureQuery(name = "usr_pro_jpa", procedureName = "user_pro", parameters = {
		  @StoredProcedureParameter(mode = ParameterMode.IN, name = "last_name", type = String.class),
		  @StoredProcedureParameter(mode = ParameterMode.OUT, name = "counts", type = Integer.class) })*/
public class User {
	@Id
